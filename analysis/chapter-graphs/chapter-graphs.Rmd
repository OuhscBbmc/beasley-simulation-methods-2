...
```{r waiting-times-basic, fig.width=8, fig.height=2, echo=echo_chunks, message=message_chunks}
```

Example 2: Sampling Frames 
===========================================================================

```{r sampling-frame, fig.width=4.2, fig.height=1.6, echo=echo_chunks, message=message_chunks}
```

Example 3: Rejection Sampling
===========================================================================

```{r rejection-sampling, fig.width=8, fig.height=3, echo=echo_chunks, message=message_chunks}
```

Example 4: Independent Metropolis-Hastings
===========================================================================

```{r independent-metropolis-hastings, fig.width=8, fig.height=3, echo=echo_chunks, message=message_chunks}
```
