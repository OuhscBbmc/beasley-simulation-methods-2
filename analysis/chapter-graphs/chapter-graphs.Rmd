...
```{r waiting-times-basic, echo=echo_chunks, message=message_chunks}
```
...
```{r rejection-sampling, echo=echo_chunks, message=message_chunks}
```

Example 4: Independent Metropolis-Hastings
===========================================================================

```{r independent-metropolis-hastings, echo=echo_chunks, message=message_chunks}
```
